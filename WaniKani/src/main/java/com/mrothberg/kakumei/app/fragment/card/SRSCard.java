...
public class SRSCard extends Fragment {
    ...
    private BroadcastReceiver mDoLoad = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            waniKaniAPI.getSRSDistribution().whenComplete((srsDistribution, throwable) -> {
                if(throwable != null || srsDistribution == null) {
                    Log.e("SRSCard", "getSRSDistribution() api call failed: " + throwable);
                    srsDistribution = DatabaseManager.getSrsDistribution();
                }
                displayData(srsDistribution);
            });
        }
    };
