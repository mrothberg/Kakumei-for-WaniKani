package com.mrothberg.kakumei.database;
...
import com.mrothberg.kakumei.database.table.CriticalItemsTable;
import com.mrothberg.kakumei.database.table.ItemsTable;
import com.mrothberg.kakumei.database.table.LevelProgressionTable;
import com.mrothberg.kakumei.database.table.NotificationsTable;
import com.mrothberg.kakumei.database.table.RecentUnlocksTable;
import com.mrothberg.kakumei.database.table.SRSDistributionTable;
import com.mrothberg.kakumei.database.table.StudyQueueTable;
import com.mrothberg.kakumei.database.table.UsersTable;
import com.mrothberg.kakumei.database.table.UsersTableV2;
...
public class DatabaseManager {
    ...
    private static void addUserV2(UserData user) {
        ContentValues values = new ContentValues();
        values.put(UsersTableV2.COLUMN_NAME_USERNAME, user.username);
        values.put(UsersTableV2.COLUMN_NAME_LEVEL, user.level);
        values.put(UsersTableV2.COLUMN_NAME_STARTED_AT, user.started_at);
        db.insert(UsersTableV2.TABLE_NAME, UsersTableV2.COLUMN_NAME_NULLABLE, values);
    }
    ...
    public static void saveUserV2(UserData user) {
        deleteUsersV2();
    ...
    public static UserData getUserV2() {
        Cursor c = null;

        try {
            c = db.query(
                    UsersTableV2.TABLE_NAME,
                    UsersTableV2.COLUMNS,
                    null,
                    null,
                    null,
                    null,
            ...
            if (c != null && c.moveToFirst()) {
                return new UserData(
                        c.getString(c.getColumnIndexOrThrow(UsersTableV2.COLUMN_NAME_USERNAME)),
                        c.getInt(c.getColumnIndexOrThrow(UsersTableV2.COLUMN_NAME_LEVEL)),
                        c.getString(c.getColumnIndexOrThrow(UsersTableV2.COLUMN_NAME_STARTED_AT))
                );
            } else {
                Log.e(TAG, "No users found; returning null");
                return null;
    ...
    public static void deleteUsersV2() {
        db.delete(UsersTableV2.TABLE_NAME, null, null);
    }
