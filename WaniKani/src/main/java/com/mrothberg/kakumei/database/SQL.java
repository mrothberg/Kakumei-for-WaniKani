...
public class SQL {
    ...
    public static final String CREATE_TABLE_USERS_V2 = "CREATE TABLE "
            + UsersTableV2.TABLE_NAME + " ("
            + UsersTableV2.COLUMN_NAME_ID + INTEGER_PRIMARY_KEY_AUTOINCREMENT + COMMA_SEP
            + UsersTableV2.COLUMN_NAME_USERNAME + TEXT_TYPE + COMMA_SEP
            + UsersTableV2.COLUMN_NAME_LEVEL + INTEGER_TYPE + COMMA_SEP
            + UsersTableV2.COLUMN_NAME_STARTED_AT + TEXT_TYPE + COMMA_SEP
            + UsersTableV2.COLUMN_NAME_NULLABLE + TEXT_TYPE  + ")";
