...
import com.mrothberg.kakumei.widget.adapter.LevelPickerCheckBoxAdapter;
...
public class LevelPickerDialogFragment extends DialogFragment implements LevelPickerCheckBoxAdapter.LevelPickerCheckBoxAdapterListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        //TODO: IMPORTANT this should only show all levels if the user has an active subscription
