...
public class BaseItem implements Serializable {
    ...
    public String getOnyomi() {
        return isKanjiItem() ? onyomi : null;
    }

    public String getKunyomi() {
        return isKanjiItem() ? kunyomi : null;
    }

    public String getImportantReading() {
        return isKanjiItem() ? important_reading : null;
    }
    ...
    public int getReadingCorrect() {
        return isUnlocked() ? isKanjiOrVocabularyItem() ? user_specific.reading_correct : 0 : 0;
    }

    public int getReadingIncorrect() {
        return isUnlocked() ? isKanjiOrVocabularyItem() ? user_specific.reading_incorrect : 0 : 0;
    }

    private boolean isKanjiOrVocabularyItem() {
        return isKanjiItem() || isVocabularyItem();
    }

    private boolean isKanjiItem() {
        return getType() == ItemType.KANJI;
    }

    private boolean isVocabularyItem() {
        return getType() == ItemType.VOCABULARY;
    }

    public int getReadingMaxStreak() {
        return isUnlocked() ? isKanjiOrVocabularyItem() ? user_specific.reading_max_streak : 0 : 0;
    }

    public int getReadingCurrentStreak() {
        return isUnlocked() ? isKanjiOrVocabularyItem() ? user_specific.reading_current_streak : 0 : 0;
    }

    public int getReadingAnswersCount() {
        return isUnlocked() ? isKanjiOrVocabularyItem() ?
    ...
    public String getReadingNote() {
        return isUnlocked() ? isKanjiItem() ? user_specific.reading_note : null : null;
    }
